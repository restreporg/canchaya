...
@section('body')
    ...
    <div class="mb-4">
        <a href="{{ route('admin.reservations.index') }}" class="btn btn-sm btn-outline-secondary btn-pill px-3">
    ...
    <div class="row g-4">
        <div class="col-md-6">
            <div class="card border-0 shadow-sm mb-3 card-soft">
                <div class="card-header bg-white fw-semibold border-0 pt-3">Reserva #{{ $reservation->id }}</div>
                <div class="card-body">
            ...
            <div class="card border-0 shadow-sm card-soft">
                <div class="card-header bg-white fw-semibold border-0 pt-3">Pago</div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            ...
            <div class="card border-0 shadow-sm card-soft">
                <div class="card-header bg-white fw-semibold border-0 pt-3">Reseña</div>
                <div class="card-body">
