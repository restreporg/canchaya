...
<head>
    ...
    <title>Sesión expirada - Canchaya</title>
...
<body>
    ...
    <section class="hero d-flex align-items-center text-white">
        <div class="container text-center py-5">
            ...
            <p class="error-code text-verde mb-0">419</p>
            <h1 class="hero-title mb-4">Sesión expirada</h1>
            <p class="lead text-white-50 mb-5 mx-auto" style="max-width: 500px;">
                Tu sesión ha expirado por seguridad. Vuelve a iniciar sesión para continuar.
            </p>
