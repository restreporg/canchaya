...
<head>
    ...
    <title>En mantenimiento - Canchaya</title>
...
<body>
    ...
    <section class="hero d-flex align-items-center text-white">
        <div class="container text-center py-5">
            ...
            <p class="error-code text-verde mb-0">503</p>
            <h1 class="hero-title mb-4">En mantenimiento</h1>
            <p class="lead text-white-50 mb-5 mx-auto" style="max-width: 500px;">
                Estamos realizando mejoras en la plataforma. Vuelve a intentarlo en unos minutos.
            </p>
