...
<head>
    ...
    <title>Error del servidor - Canchaya</title>
...
<body>
    ...
    <section class="hero d-flex align-items-center text-white">
        <div class="container text-center py-5">
            ...
            <p class="error-code text-verde mb-0">500</p>
            <h1 class="hero-title mb-4">Error del servidor</h1>
            <p class="lead text-white-50 mb-5 mx-auto" style="max-width: 500px;">
                Algo salió mal de nuestro lado. Ya estamos trabajando para solucionarlo, intenta de nuevo en unos minutos.
            </p>
